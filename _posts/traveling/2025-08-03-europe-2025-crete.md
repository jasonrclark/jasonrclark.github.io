...
The airport on Crete is a pretty small one (although as we'd find out, it is
also one of two airports on the island. This made it easy to find get to the
rental car area -- just walk outside. We tried briefly to get the navigation in
the car to work, but it insisted on "Attaching with USB and starting your
navigation app," none of which worked. Back to me holding up the iPhone while
Google maps did its thing.

An oddity we noticed almost immediately during the half hour drive was that
folks perpetually pulled over until their cars were overlapping or even entirely
in the shoulder when there was space. Faster traffic then would buzz by in the
partial lane. It took a few minutes to realize this was the driving cultural
norm, not just some weird tentative driver ahead of us, but after that Amber did
...
Academy of Crete](https://www.oac.gr/en/) where the unconference would be held.
Following the map, we turned up a narrow one-way street with cars parked all
along one side of it. The buildings were almost entirely unnumbered, and the map
pinned a location that very plainly _wasn't_ our apartment. We fumbled around
for several minutes, walking up and down the street until we realized that a big
wooden sliding gate we'd passed by was our entrance.

{% include image.html caption="Our rustic apartment" url="/images/travel/2025-Crete/crete-rustic-apartment.jpg" %}

The apartment was a lovely rustic little place. Behind the gate was a porch area
with a long table, barbecue (which we never ended up using), an outdoor shower
and some loungers. The walls of the place were made of stone, which kept it
somewhat cool inside although we did kick the AC on when we were in. The living
and bathrooms had plainly been renovated not long in the past, with a nice
modern flair that actually suited the space well.
...
roll out whatever goodness he was delivering and to take the dishes away.

A "feature" of the apartment that we weren't really prepared for was the
cicadas, which were very much in season when we were there in early August.
While present almost everywhere we went in Crete, they seemed to especially
congregate out on our porch. We referred to it as the "cicada sex dungeon" given
it's popularity. Twice while we were there I wrote a little out at the otherwise
lovely table, but the noise was right on the edge of headache-inducing so we
didn't spend much other time there.
...
As the "J" in JCrete suggests, the central programming topic that draws folks in
is Java. It had been about a year and a half since I was using much Java in my
professional context (moving from New Relic to GitHub meant trading my backend
Java for Ruby, TypeScript and a smattering of Go), but I found it was like
riding a bike. I quickly immersed back into the topic, and in fact proposed a
couple of sessions that got selected.
...
Lunches were around 1 each day, and partners and family, which are highly
...
The third day of JCrete was scheduled for sessions in the afternoon rather than
the morning to support folks making an excursion out to to some beaches. The
downside of this plan, though, was that the approach to said beaches was an
unpaved road, the type specifically called out as excluded on our rental
contract. That plus the really early start time convinced us to just stay in
town and have a late brunch with our dear friends instead.
...
on the JDK, and a session titled "Java in Space." Came to find out that in fact
while Java is used plenty in mission control software, it is _not_ actually on
...
After sessions we spent some beach time, bobbing in the lovely Mediterranean
waters which I have missed a ton since moving away from Barcelona. Up at OAC
after that a Cretan evening was scheduled, with folk music, dancers, and
traditional food galore. And yes, even I was coerced into dancing (badly) as the
...
other language ecosystems where so much is already in the box that you need to
reach for external libraries to get in Java. Hoping an equivalent to `require
'json'; JSON.parse(...)` lands sometime in the future. There was also some solid
discussion of observability -- a topic still dear to my heart -- and a lightly
attended session I proposed about writing technical books.

{% include image.html caption="Monastery near OAC" url="/images/travel/2025-Crete/crete-monastery.jpg" %}

The evening plan was yet another event as OAC, this one a full barbecue put on
by members of the unconf planning crew. The food was tasty, and the socializing
fun, with little to no threat this time around of dancing.

{% include image.html caption="The JCrete crew" url="/images/travel/2025-Crete/crete-jcrete.jpg" %}

## JCrete Day 5

The last day of the unconference many folks had actually already left for, so
typical sessions were replaced by a morning of hacking. It was a joy to spend
that time across a table from Ben, working first on a proposal for a refreshed
version of one of our books, and then jamming on a retro game ported to Java
that he's been trying to get into working order.
...
with smaller groups to crowd-source ideas, but never with a multi-session
output. It was surprisingly rich, often insightful, and always fun. Looking
forward to attending again in some future year.
...
[Kosmas](https://www.kosmastaverna.gr/), and we dragged Ben and Anna along for
the twenty minute drive there. It was an interesting change, heading into the
more populated and touristy stretches of Crete closer to Chania. It highlighted
just how quiet and secluded Kolymbari actually was.

We parked on a busy street, found our way into the restaurant and cracked open
the menus. To our dismay, though, while it listed all sorts of desserts there
were no loukoumades to be found. Mildly panicked, Amber flagged over the waiter
and asked after our favorite Greek treat. Apparently, they're just gifted
alongside a meal rather than being ordered -- actually a common occurrence at
many of the restaurants we visited, although more often it was a flan/custard
with citrus and a shot of raki. Fortunately they were willing to sell us the
loukoumades as long as we ordered the baklava too. Minor sadness I couldn't try
because I was doing an allergy test excluding nuts which I'd shown some
sensitivity too (news flash: didn't help and I missed pastries in Greece and
pistachio gelato in Italy because of it 😭).
...
Back in Athens, Amber had spotted a lovely olive wood cutting board at one of
our meals. This gave us our shopping quest on the island. We trotted back on an
...
rich, natural wood products Amber was after. Needless to say, we ended up buying
another suitcase to fit that and some gifts that we received from friends. It
was worth it though.
...
owner contacted us an gifted us twenty euros to buy a bottle of wine as a gift.
I think he was aware just how loud it had been so very late at the festival.

Our flight out went fine back to Athens -- it's hard to get anywhere except
there from Crete! -- and then our next hop was on Ryanair to
