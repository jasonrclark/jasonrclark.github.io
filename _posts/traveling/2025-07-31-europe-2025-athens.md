...
museum has many spacious, open rooms with statuary, leading off then to smaller
...
And then there were a few bits that, well, I'm not much of an artist but I feel
like even I could have nailed it better.
...
once the statues, I think maybe of one of the Furies, really just reminded me of
some old witch from a Studio Ghibli movie.
...
We went in with some nerves. How would they hold up? Were we in love with a
fake, Americanized version of the treat? But the answer was a resounding "no!"
Krinos' loukoumades came in a slightly different shape -- circular rather than
the donut hole style we were familiar with -- but the light crispiness, the
perfect sticky sweetness of the honey, the dash of cinnamon all hit just right.

On the walk back to the hotel we passed a shop with tables out onto the sidewalk
...
reservations, though, and bit by bit folks were being let inside so we just
lined up.
...
some of the meal and joined the evening throng down narrow streets to the place.
...
place was the hipster revision on the classic. You want your loukoumades with
filled with chocolate or pistachio? Dipped in some sort of frosting? Served with
...
So part of our time in Athens was an abject failure. We lost most of a day
getting there with the flight re-arrangements, and we didn't realize that the
entry to the Parthenon and Acropolis were time-ticketed events. Finally
researching when we were in town, we found that there just wasn't a reasonable
time for us to make it to these iconic locations. At least we could see them
from a distance.

{% include image.html caption="Acropolis in the distance" url="/images/travel/2025-Athens/athens-distant-acropolis.jpg" %}

However, at lovely part about Athens is that there are more ruins than just the
Parthenon to see. And in fact, many of them don't entail hours standing in line,
in the hottest part of the day, climbing huge stairs to view.
...
Backtracking the way we'd walked to the Agora, we found a fairly typical cafe
lunch. The fans running at the edges of the outdoor seating really sold it.
